...
D = ["'{\"address\": {\"6.6.6.6/32\": {}}}'", "'{\"address\": {\"%s\": {}}}'"% ips[0],"'{\"address\": {\"%s\": {}}}'"% ipv6s[0],"'{\"address\": {\"6.1.68.1/16\": {}}}'","'{\"address\": {\"6:1:68::1/64\": {}}}'","'{\"address\": {\"5.1.56.2/16\": {}}}'", "'{\"address\": {\"5:1:56::2/64\": {}}}'", "'{\"address\": {\"5.2.56.2/16\": {}}}'", "'{\"address\": {\"5:2:56::2/64\": {}}}'", "'{\"%s\": {}}'"% bonds[0], "'{\"member\": {\"%s\": {}}}'"% swps[randrange(1,len(swps))],"'{\"mlag\": {\"id\": %s}}'"% random.randrange(1,10),"'{\"br_default\": {\"access\": %s}}'"% VLANS[0],"'{\"untagged\": 1}'","'{\"vlan\" : {\"%s\": {}}}'"% VLANS[0],
